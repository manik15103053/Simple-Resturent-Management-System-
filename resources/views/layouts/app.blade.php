...
<body>
  ...
  <!--  Google Maps Plugin    -->
  <script src"{{asset('backend/maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE')}}"></script>
  <!-- Chartist JS -->
  <script src="{{asset('backend/js/plugins/chartist.min.js')}}"></script>
  <!--  Notifications Plugin    -->
  <script src="{{asset('backend/js/plugins/bootstrap-notify.js')}}"></script>
  <!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages{{asset('backend/js/material-dashboard.js?v=2.1.1')}}  <!-- Material Dashboard DEMO methods, don't include it in your project! -->
